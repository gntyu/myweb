...
const earthBg = require("./assets/bg-stars-large.png");
...
class ThreeMap extends Component{
	...
	initThree(){
		...
		function init() {
			...
			let planetTexture = require("./assets/earth-bump.jpg");
	...
	render(){
		return(
			<div id='WebGL-output' style={{width: '100%',height: '500px',backgroundImage:earthBg}}></div>
		)
	}
}
